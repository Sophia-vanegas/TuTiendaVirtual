...
def init_db():
    ...
    if not admin:
        ...
        prods = [
            ...
            ("1", "Arroz Blanco Premium (1kg)", "Alimentos", 100, 4500, "https://images.unsplash.com/photo-1586201375761-83865001e31c?w=500"),
            ("2", "Frijoles Rojos (1kg)", "Alimentos", 80, 8200, "https://images.unsplash.com/photo-1551462147-ff29053bfc14?w=500"),
            ("3", "Aceite Vegetal (1L)", "Alimentos", 60, 12500, "https://images.unsplash.com/photo-1474979266404-7eaacbadcbaf?w=500"),
            ("4", "Leche Entera Larga Vida (1L)", "Alimentos", 90, 4200, "https://images.unsplash.com/photo-1563636619-e910ef493996?w=500"),
            ("5", "Huevos AA (Panal x30)", "Alimentos", 50, 18000, "https://images.unsplash.com/photo-1506976785307-8732e854ad03?w=500"),
            ("6", "Pan Tajado Familiar", "Alimentos", 40, 5500, "https://images.unsplash.com/photo-1509440159596-0249088772ff?w=500"),
            ("7", "Cafe Molido Selecto (500g)", "Alimentos", 70, 15000, "https://images.unsplash.com/photo-1559056199-641a0ac8b55e?w=500"),
            ("8", "Azucar Blanca (1kg)", "Alimentos", 120, 3800, "https://images.unsplash.com/photo-1622484211148-713284f67645?w=500"),
            ("9", "Sal Marina (1kg)", "Alimentos", 100, 2200, "https://images.unsplash.com/photo-1626131731323-e6711bb619fe?w=500"),
            ("10", "Pasta Espagueti (500g)", "Alimentos", 110, 3500, "https://images.unsplash.com/photo-1551183053-bf91a1d81141?w=500"),
            ("11", "Atun Enlatado (170g)", "Alimentos", 75, 6500, "https://images.unsplash.com/photo-1631193945979-e5db66f2a84f?w=500"),
            ("12", "Tomates Frescos (1kg)", "Alimentos", 60, 8000, "https://images.unsplash.com/photo-1592841494900-055cc937943a?w=500"),
            ("13", "Cebolla Blanca (1kg)", "Alimentos", 80, 3500, "https://images.unsplash.com/photo-1585518419759-55b725a5b65f?w=500"),
            ("14", "Ajo Fresco (250g)", "Alimentos", 50, 9000, "https://images.unsplash.com/photo-1577003834202-eb4d7206e088?w=500"),
            ("15", "Harina de Trigo (1kg)", "Alimentos", 95, 4200, "https://images.unsplash.com/photo-1585707572537-b6237b2ecbcd?w=500"),
            ("16", "Azucar Morena (1kg)", "Alimentos", 60, 5500, "https://images.unsplash.com/photo-1599788690732-fc91cadbd5c3?w=500"),
            ("17", "Chocolate en Polvo (200g)", "Alimentos", 45, 8500, "https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=500"),
            ("18", "Leche Condensada (397g)", "Alimentos", 70, 6800, "https://images.unsplash.com/photo-1550521323-9ca0ba017d26?w=500"),
            # LIMPIEZA (12 productos)
            ("19", "Detergente en Polvo (2kg)", "Limpieza", 80, 15800, "https://images.unsplash.com/photo-1584622781564-1d9876a13d00?w=500"),
            ("20", "Lavaloza Liquido Limon (500ml)", "Limpieza", 100, 6500, "https://images.unsplash.com/photo-1603530635183-0599a80509a2?w=500"),
            ("21", "Desinfectante Multiusos (1L)", "Limpieza", 75, 7200, "https://images.unsplash.com/photo-1584309662032-3562a35b6658?w=500"),
            ("22", "Blanqueador Cloro (1L)", "Limpieza", 90, 4500, "https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=500"),
            ("23", "Jabon de Bano Cremoso (x3)", "Limpieza", 60, 9500, "https://images.unsplash.com/photo-1600857062241-98e5dba7f214?w=500"),
            ("24", "Papel Higienico Soft (8 rollos)", "Limpieza", 85, 14000, "https://images.unsplash.com/photo-1591047990981-50e86b1ca516?w=500"),
            ("25", "Esponja de Cocina Doble Uso (x3)", "Limpieza", 120, 3000, "https://images.unsplash.com/photo-1583947215259-38e31be8751f?w=500"),
            ("26", "Suavizante de Ropas (1L)", "Limpieza", 65, 11000, "https://images.unsplash.com/photo-1594736797933-d0501ba2fe65?w=500"),
            ("27", "Limpiavidrios (500ml)", "Limpieza", 55, 5800, "https://images.unsplash.com/photo-1584840099259-02c8c8c2df0d?w=500"),
            ("28", "Bolsas de Basura Negras (x10)", "Limpieza", 100, 6000, "https://images.unsplash.com/photo-1591193520257-c030ea854088?w=500"),
            ("29", "Desengrasante Cocina (500ml)", "Limpieza", 70, 8500, "https://images.unsplash.com/photo-1585329267302-97382be59b6d?w=500"),
            ("30", "Ambientador en Spray (300ml)", "Limpieza", 80, 4800, "https://images.unsplash.com/photo-1589985643096-92268e22bf00?w=500"),
        ]
